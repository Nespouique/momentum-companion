# Story 1.3: Sync background et envoi API
...
### API Payload Format (POST /health-sync)
...
data class SleepRecord(
    ...
    val endTime: String,              // ISO 8601
    val durationMinutes: Double,
    val score: Int?,                  // Not used by API (stores durationMinutes instead), kept for forward compat
...
data class TrackablesStatus(
    ...
    val sleepDuration: TrackableInfo?
)
